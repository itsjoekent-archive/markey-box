  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        ...
        <p className="footnote">This directory will be updated frequently. Please use this tool to search for the location of the ballot drop boxes in your community. You can only drop off your ballot in a dropbox in your own community. Please be advised that you cannot drop off your ballot at a polling place, only a secure dropbox or your local election office.</p>
